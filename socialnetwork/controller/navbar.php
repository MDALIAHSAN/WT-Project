<div class="usernav">
    ...
    <li><a href="../view/upload.html">File upload</a></li><li><a href="../view/requests.php">Friend Requests (<?php echo $row['count'] ?>)</a></li><li><a href="../view/profile.php">Profile</a></li><li><a href="../view/friends.php">Friends</a></li><li><a href="../view/home.php">Home</a></li><li><a href="../view/logout.php">Log Out</a></li>
    </ul>
    <div class="globalsearch">
        <form method="get" action="../view/search.php" onsubmit="return validateField()"> <!-- Ensure there are no enter escape characters.-->
